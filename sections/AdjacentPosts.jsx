...
const AdjacentPosts = ({ createdAt, slug }) => {
    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-8 gap-12 mb-4">
            {dataLoaded && (
                <>
                    {adjacentPost.previous && (
                        <div className={`${adjacentPost.next ? 'col-span-1 lg:col-span-4 mb-4' : 'col-span-1 lg:col-span-8'} adjacent-post rounded-lg relative h-72`}>
