                        ...
                        >
                            <div
                                ...
                                <div className="sm:flex sm:items-start">
                                    <button
                                        type="button"
                                        className="absolute text-white/50 bg-amber-500/10 rounded-lg px-3 right-0 mr-5 mt-5 transition duration-200 hover:text-white hover:bg-amber-500 focus:outline-none"
