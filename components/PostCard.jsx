...
const PostCard = ({ post }) => {
    return (
        <div className='bg-lighter-washed-black shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8 text-white'>
            ...
            <p className='text-center text-lg text-neutral-200 font-medium px-4 lg:px-20 mb-8'>
                {post.brief}
            </p>
            <div className='text-center'>
                <Link href={`/post/${post.slug}`}>
                    <span className='transition duration-500 transform hover:-translate-y-1 inline-block bg-amber-500
