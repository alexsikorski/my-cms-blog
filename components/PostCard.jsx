...
const PostCard = ({ post }) => {
    return (
        <div className='bg-lighter-washed-black shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-4 text-white'>
            ...
            <h1 className='transition duration-400 text-center mb-4 cursor:pointer
            ...
            <p className='text-center text-lg text-neutral-200 font-medium px-4 lg:px-20 mb-4'>
                {post.brief}
            </p>
