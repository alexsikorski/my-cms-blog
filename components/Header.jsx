...
const Header = () => {
    ...
    return <div className='container mx-auto px-10 mb-4 select-none'>
        <div className='border-b w-full inline-block border-white/5 py-6 '>
            ...
            <div>
                <button id="dropdownDefault" data-dropdown-toggle="dropdown" className='float-right ml-2 lg:ml-4 text-white lg:invisible md:visible sm:visible
                 inline-block bg-amber-500 rounded-lg text-white cursor-pointer drop-shadow w-10 mt-2 text-center p-1'>
                    <svg xmlns="http://www.w3.org/2000/svg"
                        fill="currentColor" viewBox="0 0 50 50" width="28" height="28" stroke='white' stroke-width="1">
                ...
                <span>
                    <a href="https://www.linkedin.com/in/alex-sikorski-541249182/" target="_blank" className="float-right mt-2 lg:ml-4 ml-2 align-middle text-white hover:text-amber-500 transition duration-400 hover:cursor-pointer 
                ...
                <span>
                    <a href="https://github.com/alexsikorski" target="_blank" className="float-right mt-2 lg:ml-4 ml-2 align-middle text-white hover:text-amber-500 transition duration-400 hover:cursor-pointer
                    transition duration-500 transform hover:-translate-y-1 hover:text-amber-500">
                        <svg xmlns="http://www.w3.org/2000/svg"
