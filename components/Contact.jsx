    ...
    return (<>
        <div className='bg-lighter-washed-black shadow-lg rounded-lg p-8 pb-12'>
            ...
            <a href="https://www.linkedin.com/in/alex-sikorski-541249182/" target="_blank">
                <svg xmlns="http://www.w3.org/2000/svg" className="text-neutral-200 hover:text-amber-500 transition duration-400 hover:cursor-pointer"
                    fill="currentColor" viewBox="0 0 26 26" width="26" height="26" >
